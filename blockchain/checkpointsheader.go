...
// CheckpointHeader identifies a known good point in the block chain.
type CheckpointHeader struct {
	Height uint32
	Header wire.BlockHeader
}

var mainnetCheckpoints []CheckpointHeader
var testnet3Checkpoints []CheckpointHeader
var regtestCheckpoint CheckpointHeader
...
func init() {
	...
	mainnetCheckpoints = append(mainnetCheckpoints, CheckpointHeader{
		Height: 473760,
		Header: wire.BlockHeader{
			Version:    536870914,
	...
	testnet3Checkpoints = append(testnet3Checkpoints, CheckpointHeader{
		Height: 1151136,
		Header: wire.BlockHeader{
			Version:    536870912,
	...
	// Regtest
	regtestCheckpoint = CheckpointHeader{0, chaincfg.RegressionNetParams.GenesisBlock.Header}
}

// GetCheckpoint return
func GetCheckpoint(walletCreationDate time.Time, params *chaincfg.Params) CheckpointHeader {
	switch params.Name {
